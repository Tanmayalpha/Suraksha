...
class CashFreePaymentMethod extends StatefulWidget {
  const CashFreePaymentMethod({Key? key}) : super(key: key);

  @override
  State<CashFreePaymentMethod> createState() => _CashFreePaymentMethodState();
}

class _CashFreePaymentMethodState extends State<CashFreePaymentMethod> {
  ...
  String orderId = "order_101484602dZtHEAIPj8NnyjkxfURLffXmov";
  String paymentSessionId = "session_4cpJ1obOdSq3u3PVp6y2t53luxaIDvqj7_7WGdJVMq9eXxz10EE9TKBV9Dekc16Wfc6IijLoY81T1obZHn9usLDCQ9uAWgUzc05nF-TiXi-j";
